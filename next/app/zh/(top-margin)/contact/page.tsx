...
import { MultiFileField } from "@/app/_components/locale/(top-margin)/contact/_components/MultiFileField";

function contactLocalised() {
  return {
    header: "联系我们",
    fields: [
      {
...
export default function ContactPage() {
  const locale = "zh";
  const { header, fields, captcha, submit, contactDetails } = contactLocalised();
